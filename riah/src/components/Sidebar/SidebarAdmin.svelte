...
>
  ...
  >
    ...
    <a
      ...
      class="md:block text-center text-gray-900 mr-0 p-4 px-0"
      href="/#/dashboard"
    >
    <p class="lg:hidden sm:inline-block">RIAH</p>
    <img src="../images/logo3.png" alt="logo"  class="hidden lg:inline-block h-20 w-25 object-center">
    </a>
    <!-- User -->
    ...
    >
      ...
      >
        <div class="flex flex-wrap">
          <div class="w-6/12">
            <a href="/#/dashboard"           
              class="md:block text-left md:pb-2 text-gray-900 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0">
              RIAH
            </a>
          </div>
